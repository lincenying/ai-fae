[当前文档访问路径](https://ai-fae.readthedocs.io/zh-cn/latest/ok_Baichuan2-13B%20微调推理(910b).html)
...
--torch_ckpt_path /home/ma-user/work/mindformers/research/baichuan2/13b/pytorch_model.bin \
--mindspore_ckpt_path /home/ma-user/work/mindformers/research/baichuan2/13b/pytorch_model.ckpt

mkdir -p ./research/baichuan2/13b/rank_0
mv ./research/baichuan2/13b/pytorch_model.ckpt ./research/baichuan2/13b/rank_0
...
--input_glob /home/ma-user/work/mindformers/research/baichuan2/13b/belle_chat_ramdon_10k.json \
--model_file /home/ma-user/work/mindformers/research/baichuan2/13b/tokenizer.model \
--output_file /home/ma-user/work/mindformers/research/baichuan2/13b/belle_512.mindrecord \
--seq_length 512
...
```bash
vi /home/ma-user/work/mindformers/research/baichuan2/run_baichuan2_13b_lora_910b.yaml
```
...
train_dataset: &train_dataset
  data_loader:
    type: MindDataset
    dataset_dir: "/home/ma-user/work/mindformers/research/baichuan2/13b/belle_512.mindrecord"
    shuffle: True
...
```bash
vi /home/ma-user/work/mindformers/research/baichuan2/run_baichuan2_13b_910b.yaml
```
...
processor:
  ...
  tokenizer:
    ...
    vocab_file: '/home/ma-user/work/mindformers/research/baichuan2/13b/tokenizer.model'
  type: LlamaProcessor
```
